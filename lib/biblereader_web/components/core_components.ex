defmodule BibleReaderWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(BibleReaderWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(BibleReaderWeb.Gettext, "errors", msg, opts)
    end
  end
