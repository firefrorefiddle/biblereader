...
config :biblereader, BibleReaderWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: BibleReaderWeb.ErrorHTML, json: BibleReaderWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: BibleReader.PubSub,
  live_view: [signing_salt: "AOO1hTUA"]
...
config :biblereader, BibleReader.Mailer, adapter: Swoosh.Adapters.Local
